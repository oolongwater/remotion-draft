...
<overview>
This gallery contains a collection of best practice code snippets together with their corresponding video/image output, illustrating different functionalities all across the library. These are all under the MIT license, so feel free to copy & paste them to your projects.

**Important Notes:**
- This gallery is not the only place in our documentation where you can see explicit code and video examples
- There are many more examples in our reference manual (tex_mobject, geometry, moving_camera_scene, etc.)
- Check out our interactive Jupyter environment which allows running the examples online
- Visit our Twitter for more manimations
</overview>

<section name="basic-concepts">
## Basic Concepts
...
**Note:** You can use multiple ValueTrackers simultaneously.
...
<section name="advanced-projects">
## Advanced Projects
